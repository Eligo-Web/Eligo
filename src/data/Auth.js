...
const sp_options = {
  ...
  private_key: fs.readFileSync("/home/amir/Eligo/src/data/key-file.pem").toString(), // private key
  certificate: fs.readFileSync("/home/amir/Eligo/src/data/cert-file.crt").toString(), // public key
...
const idp_options = {
  ...
  certificates: [fs.readFileSync("/home/amir/Eligo/src/data/idp-cert-file1.crt").toString(),
                fs.readFileSync("/home/amir/Eligo/src/data/idp-cert-file2.crt").toString()], // public key
};
